...
<head>
    ...
    <script src="/Front/JS/validaDatas.js" ></script>
</head>
<body>
                    ...
                    <form action="../Back/cadastraEvento.php" method="post">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select id="evento" name="evento" class="form-control input-with-icon">
                                    ...
                                    <option value="seteic">Seteic</option>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" id="date" class="form-control input-with-icon" name="date">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="time" id="horaInicio" class="form-control input-with-icon" name="horaInicio">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <i class="fas fa-clock input-icon"></i>
                                <input type="time" id="horaFinal" class="form-control input-with-icon" name="horaFinal">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="local" class="form-control input-with-icon" name="local" placeholder="Local da Atividade">
                            </div>
                        </div>
